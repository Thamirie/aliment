<?php
  function verificarAcesso() {
    ...
    if ($_SESSION["superioridade"] !== "Alto") {
  ...
  <main class="container" style="display: flex; justify-content:center; align-items:center; padding: 25px;flex-direction:column;">
    ...
    <div class="div">
      ...
      <div style="display: flex; justify-content:center; align-items:center; flex-direction:column;">
        ...
        <div class="admin-option" onclick="confirmarExclusao(<?php echo $row['id']; ?>)">
  ...
  <script>
    function confirmarExclusao(adminId) {
      if (confirm("Tem certeza de que deseja excluir este administrador?")) {
        window.location.href = "excluir_administrador.php?id=" + adminId;
      }
    }
  </script>
</body>
